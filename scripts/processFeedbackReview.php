...
mail("sk24751@gmail.com", $_POST['subject'], $messageToBusiness, $headerToBusiness);

//Construct the confirmation message to be e-mailed to the client
$messageToClient =
    "Dear ".$_POST['salute']." ".$_POST['lastName'].":\r\n".
    "The following message was received from you by Arts N' Crafts Depot:\r\n\r\n".
    $messageToBusiness.
    "------------------------\r\nThank you for the feedback and your patronage.\r\n" .
    "The Arts N' Crafts Depot Staff\r\n------------------------\r\n";
if ($_POST['reply'])
